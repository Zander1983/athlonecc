define(function (require) {
    ...
    var $                   = require('jquery'),
        ...
        ExtraCurricular = Backbone.Model.extend({  

        }),

        
        ExtraCurricularCollection = Backbone.Collection.extend({

            model: ExtraCurricular,
            url: 'http://www.athlonecc.ie/index.php?option=com_ninjarsssyndicator&feed_id=10&format=raw',
            
            //This is used so I can test on a browser. On a device, use the direct link
          
          /*
            url: function(){
                    return "/school-proxy.php?type=extracurricular";
                 },*/
    ...
    return {
        ...
        ExtraCurricularCollection: ExtraCurricularCollection
    };
