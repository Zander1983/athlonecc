define(function (require) {
    ...
    var Backbone            = require('backbone'),
        ...
        SchoolCalendar = Backbone.Model.extend({  

        }),

        
        SchoolCalendarCollection = Backbone.Collection.extend({

            model: SchoolCalendar,
            url: 'http://www.athlonecc.ie/index.php?option=com_ninjarsssyndicator&feed_id=17&format=raw',
            
            //This is used so I can test on a browser. On a device, use the direct link
          
            /*
            url: function(){
                    return "/school-proxy.php?type=schoolcalendar";
                 },
            */
    ...
    return {
        ...
        SchoolCalendarCollection: SchoolCalendarCollection
    };
